...
| **Leg Extension (Machine)** | **130** *(hold)* | 3 × 12 | @7 | **Replaced Leg Press 09-24**, at the athlete's request. Thursday had no lower body, so he added **Leg Press 415×10 ×3** off-plan; Friday's 315 press would have been the same quads again 24 h later. The extension keeps Friday whole-body at the lowest cost available: no spinal load and no loaded hip flexion, so there's no pelvic roll-off to watch while baclofen blunts end-range feedback. 130 is under his 140 median because the quads are a day off a heavy press. **Done after the sumo, never before it.** |
